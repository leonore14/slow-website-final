  ...
  return (
    ...
    <div className="personalData">
      ...
      <div className="personalDataTitle">
        <h1>Privacy Policy for Slow Creative Studio.</h1>
      </div>

      <div className="personalDataParagraphTitle">
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Interpretation</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Definitions</h3>
      </div>
      <div className="personalDataText">
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Slow Creative, 48 Avenue
            du President Kennedy, 64200 Biarritz, France.</p>
          ...
          <br></br>
          <li>
              <strong>Website</strong> refers to Slow Creative Studio, accessible from www.slowcreativestudio.com
          </li>
          <br></br>
          <li>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Types of Data Collected</h3>
      </div>

      <div>
        <h4 className="personalDataParagraphSubSubTitle">Personal Data</h4>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h4 className="personalDataParagraphSubSubTitle">Usage Data</h4>
      </div>
      <div className="personalDataText">
      ...
      <div>
        <h4 className="personalDataParagraphSubSubTitle">Tracking Technologies and Cookies</h4>
      </div>
      <div className="personalDataText">
      ...
      <div className="personalDataParagraphSubTitle">
      ...
      <div className="personalDataParagraphSubSubTitle">
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Analytics</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Email Marketing</h3>
      </div>
      <div className="personalDataText">
        <p>
        ...
        <ul>
            <li>
                ...
                <br></br>
                <p>For more information on the privacy practices of Mailchimp, please visit their Privacy policy:</p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Legal Basis for Processing Personal Data under GDPR</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Your Rights under the GDPR</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Exercising of Your GDPR Data Protection Rights</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Your Rights under the CCPA</h3>
      </div>
      <div className="personalDataText">
        <p>
        ...
        <ul>
            <li>
                <p><strong>The right to notice.</strong> You must be properly notified which categories of Personal Data are being collected and the purposes for which the Personal Data is being used.</p>
            </li>
            <br></br>
            <li>
            <p><strong>The right to access / the right to request.</strong> The CCPA permits You to request and obtain from the Company information regarding the disclosure of Your Personal Data that has been collected in the past 12 months by the Company or its subsidiaries to a third-party for the third party's direct marketing purposes.</p>
            </li>  
            <br></br>
            <li>
            <p><strong>The right to say no to the sale of Personal Data.</strong> You also have the right to ask the Company not to sell Your Personal Data to third parties. You can submit such a request by visiting our "Do Not Sell My Personal Information" section or web page.</p>
            </li> 
            <br></br>
            <li>    
            ...
            <br></br>
            <li>
            <p><strong>The right to delete Personal Data. </strong> You also have the right to request the deletion of Your Personal Data that have been collected in the past 12 months.</p>
            </li> 
            <br></br>
            <li>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Exercising Your CCPA Data Protection Rights</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Do Not Sell My Personal Information</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Website</h3>
      </div>
      <div className="personalDataText">
        <p>
      ...
      <div>
        <h3 className="personalDataParagraphSubTitle">Mobile Devices</h3>
      </div>
      <div className="personalDataText">
        <p>
